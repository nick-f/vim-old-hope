...
" * Diff
call oldhope#SetHi ("DiffAdd"       , s:vGreen        , s:vBg           , s:vNone      )
call oldhope#SetHi ("DiffChange"    , s:vYellow       , s:vBg           , s:vNone      )
call oldhope#SetHi ("DiffDelete"    , s:vRed          , s:vBg           , s:vNone      )
call oldhope#SetHi ("DiffText"      , s:vGrey         , s:vNone         , s:vNone      )
" * Errors
